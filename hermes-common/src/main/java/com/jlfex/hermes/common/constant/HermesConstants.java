...
public final class HermesConstants {
	 ...
	 * 余额不足
	 */
	public static final String CODE_BUSI_01 = "01";
	public static final String TEXT_BUSI_01 = "您的账户余额不足！";
	 ...
	 * 交易流水号
	 */
	public static final String SEQ_CFCA_TX_SN = "txSN";
	 ...
	 * 中金支付配置文件路径
	 */
	public static final String PAYMENT_CONFIG_PATH = "payment";
