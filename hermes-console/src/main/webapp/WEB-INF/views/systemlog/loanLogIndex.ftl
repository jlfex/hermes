<div class="panel panel-primary">
        <div class="panel-heading">借款日志管理</div>  </div>
    	<div class="panel-body">
            <form id="searchForm" method="post" action="#">
                <div class="row">
                    <div class="col-xs-2 hm-col form-group">
                        <label for="loanNo">标编号</label>
                        <input id="loanNo" name="loanNo" value="" class="form-control" type="text">
                    </div>
                    <div class="col-xs-2 hm-col form-group">
...
jQuery(function($) {
	...
	//点击查询按钮
	$.page.loanLogMng({
    	search: '${app}/loanLog/loanLogData'
	});
});
</script>
