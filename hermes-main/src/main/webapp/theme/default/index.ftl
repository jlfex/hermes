...
<div id="content" class="content">
	...
	<div class="notice clearfix">
		<div class="u-container">
			...
			<#if notices??>
			  <#list notices as l> 
				<li data-id="${(l.id)!}"><span>${(l.updateTime)!}</span>&nbsp;<a href="${app}/help-center/1f37572b-b006-11e4-b1e0-3adca39d28f0/${(l.id)!}">${(l.articleTitle)!}</a></li>
			  </#list> 
			  <#else>
			    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;暂无公告</li>			    
			</#if>			  
			</ul>
			<div class="pull-right"><a href="${app}/help-center/1f37572b-b006-11e4-b1e0-3adca39d28f0"><@messages key="index.notice.more" />&nbsp;<i class="fa fa-angle-double-right"></i></a></div>			
		</div>
	</div>
	<!-- /notice -->
